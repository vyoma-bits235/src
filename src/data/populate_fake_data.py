...
def add_restaurant(db: Session, data: dict):
...
def main():
    ...
    {
        'id': 42285,
        'name': 'Import placeholder for 4223',
        'slug': 'import-placeholder-for-4223',
        ...
        'price': '500',
                ...
                # More product data entries here...
                

    for product_data in products:
        add_restaurant(db, product_data)
